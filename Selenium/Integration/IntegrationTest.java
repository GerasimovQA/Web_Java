...
public class IntegrationTest extends IntegrationLogic {
    ...
    public void servicesUserTest(String NewCodeSection, String NewNameSectionme, String NewPrintNameSection,
        ...
        String servicesSectionID = integrationAPI.createServicesSectionAPI(Token, CodeSection, NameSection, ParentSection, PrintNameSection,
                VendorSection);
    ...
    public void specialtysUserTest(String NameSpecialty1, String Description1, String Icon1, String Parent1,
        ...
        Token = integrationAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        String specialtyID3 = integrationAPI.createSpecialtyAPI(Token, NameSpecialty1, Description1, Icon1, Parent1);
        String specialtyID4 = integrationAPI.createSpecialtyAPI(Token, NameSpecialty2, Description2, Icon2, Parent2);
        UserID = integrationAPI.createUserAPI(Token, Login, Password, Email, Phone, Status, SecondName, FirstName, MiddleName,
                Superuser, SendEmail, Depart, Post, Role);
        ...
        integrationAPI.editSpecialtyAPI(Token, specialtyID3, NewNameSpecialty, NewDescription);
        integrationAPI.editParentSpecialtyAPI(Token, specialtyID3, NewIcon, NewParent);
        compareSpecialtyUserTwo(SecondName, FirstName, MiddleName);

        integrationAPI.deleteSpecialtyAPI(Token, specialtyID3);
    ...
    @Parameters(value = {
            "Название организации| АББРОРГ | | Поликлиника | Левое ухо | Описание организации |" +
                    ...
                    "> Кардиоцентр №2 > Кардиоцентр №3 > Кардиоцентр №4 | | 5c1e251c70a62a6ef48d76b2 | | |" +
    ...
    public void organizationUserTest(String NameOrg, String AbbrOrg, String ChiefOrg, String Help_conditionsOrg,
        ...
        integrationAPI.profileUserAPInew(Token, UserID, Service1, Depart, Ref, Post, Status, Role, Spec1, Spec2, Regalia, EmailCont,
                PhoneCont, Instagram, Vk, Whatsapp, Viber, Facebook, Other);
    ...
    public void servicesOrgTest(String CodeService1, String NameService1, String PrintNameService1, String Parent1,
        ...
        String serviceID1 = integrationAPI.createServiceOrgAPI(Token, CodeService1, NameService1, PrintNameService1, Parent1,
        ...
        String serviceID2 = integrationAPI.createServiceOrgAPI(Token, CodeService2, NameService2, PrintNameService2, Parent2,
        ...
        String serviceID3 = integrationAPI.createServiceOrgAPI(Token, CodeService3, NameService3, PrintNameService3, Parent3,
        ...
        String userID1 = integrationAPI.createUserOrgAPI(Token, OrgID, Login1, Password1, Email1, Phone1, Status1,
                SecondName1, FirstName1, MiddleName1, Superuser1, SendEmail1, Depart1, Post1, Role1);
        integrationAPI.profileUserOrg1APInew(Token, userID1, serviceID1, Depart1, Ref1, Post1, Status1, Role1, Spec11,
                Spec21, Regalia1, EmailCont1, PhoneCont1, Instagram1, Vk1, Whatsapp1, Viber1, Facebook1, Other1);
        String userID2 = integrationAPI.createUserOrgAPI(Token, OrgID, Login2, Password2, Email2, Phone2, Status2,
                SecondName2, FirstName2, MiddleName2, Superuser2, SendEmail2, Depart2, Post2, Role2);
        integrationAPI.profileUserOrg2APInew(Token, userID2, serviceID1, serviceID2, Depart2, Ref2, Post2, Status2,
                Role2, Spec12, Spec22, Regalia2, EmailCont2, PhoneCont2, Instagram2, Vk2, Whatsapp2, Viber2, Facebook2,
                Other2);
        String userID3 = integrationAPI.createUserOrgAPI(Token, OrgID, Login3, Password3, Email3, Phone3, Status3,
                SecondName3, FirstName3, MiddleName3, Superuser3, SendEmail3, Depart3, Post3, Role3);
        integrationAPI.profileUserOrg3APInew(Token, userID3, serviceID1, serviceID2, serviceID3, Depart3, Ref3, Post3,
                Status3, Role3, Spec13, Spec23, Regalia3, EmailCont3, PhoneCont3, Instagram3, Vk3, Whatsapp3, Viber3,
                Facebook3, Other3);
        compareServiceOrgTwo(NameOrg, NameService1, VendorService1, DmsCost1, OmsCost1, PmuCost1, NameService2,
                VendorService2, DmsCost2, OmsCost2, PmuCost2, NameService3, VendorService3, DmsCost3, OmsCost3,
                PmuCost3, SecondName1, FirstName1, MiddleName1, Post1, SecondName2, FirstName2, MiddleName2, Post2,
                SecondName3, FirstName3, MiddleName3, Post3);
        ...
        integrationAPI.editServiceAPI(Token, serviceID1, NewCodeService1, NewNameService1, NewPrintNameService1,
                ...
                NewPreconditionService1, NewTypeService1, NewDmsCost1, NewOmsCost1, NewPmuCost1, NewOtherCosts1,
                NewFavorit1, NewRecord1);
    ...
    public void changeUserSecondFistMiddleNameTest(String Login, String Password, String Email, String Phone, String Status,
        ...
        Token = integrationAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        UserID = integrationAPI.createUserAPI(Token, Login, Password, Email, Phone, Status, SecondName, FirstName,
                MiddleName, Superuser, SendEmail, Depart, Post, Role);
        integrationAPI.profileUserAPInew(Token, UserID, ServiceID, Depart, Ref, Post, Status, Role, Spec1, Spec2,
        ...
        changeUserSecondFistMiddleName(Login, Email, Phone, SecondName, FirstName, MiddleName, NewSecondName,
                NewFirstName, NewMiddleName, NewEmail, NewPhone, NewLogin);
    }
