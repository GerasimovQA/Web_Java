...
//        filediff.delete();
    ...
    public void editWorkerCommunicationMethodsProfile(String SecondName, String NewEmailContact,
        ...
        p.compareStringAndWebelement("+ " + NewPhoneContact.charAt(0) + " (" + NewPhoneContact.charAt(1) +
                NewPhoneContact.charAt(2) + NewPhoneContact.charAt(3) + ") " + NewPhoneContact.charAt(4) +
                NewPhoneContact.charAt(5) + NewPhoneContact.charAt(6) + "-" + NewPhoneContact.charAt(7) +
                NewPhoneContact.charAt(8) + "-" + NewPhoneContact.charAt(9) + NewPhoneContact.charAt(10), p.phoneContactProfile);
        ...
        p.compareStringAndWebelement("+ " + NewPhoneContact.charAt(0) + " (" + NewPhoneContact.charAt(1) +
                NewPhoneContact.charAt(2) + NewPhoneContact.charAt(3) + ") " + NewPhoneContact.charAt(4) +
                NewPhoneContact.charAt(5) + NewPhoneContact.charAt(6) + "-" + NewPhoneContact.charAt(7) +
                NewPhoneContact.charAt(8) + "-" + NewPhoneContact.charAt(9) + NewPhoneContact.charAt(10), p.profContPhone);
...
//Проверка сохраненных места работы и специальности
        switch (SecondName) {
            ...
            case ("Цаплин"):
                p.compareStringAndWebelement("ФГАОУ ВО Первый МГМУ им. И.М. Сеченова Минздрава" +
                        " России (Сеченовский Университет)", p.workplace.get(0));
                p.compareStringAndWebelement(Post1 + "\n" + ", \nЛекарь", p.post.get(0));
