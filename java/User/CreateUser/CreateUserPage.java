...
public class CreateUserPage extends GlobalPage {
    ...
    public CreateUserPage(RemoteWebDriver driver) {
    ...
    int SumAmbulance = 0;
    int RandomWork1 = 0;
    int RandomWork2main = 0;
    int RandomWork2sub = 0;
    ...
    public void stepTwo(String Position, String SecondName) {
        ...
        switch (SecondName) {
            ...
            case "Аниськин":
                do {
                    s = 0;
                    RandomWork1 = random(selectNameMainOrganization.size() - 1);
...
//        sleep(1000);
//        click(driver.findElement(By.xpath("//span[text()=\"" + Position + "\"]")));
//        driver.findElement(By.xpath("//span[text()=\"" + Position + "\"]")).click();
//        inputWorkerPosition.sendKeys(Keys.ENTER);
...
//                        pr(listMedSpecialty.get(RandomSpecialty).getText());
...
//                        SumSpecialty = i;
        ...
        switch (SecondName) {
            ...
            case "Авитисян":
                ...
                inputWorkerPosition.get(1).sendKeys(Keys.ENTER);
//                sleep(1000);
//                click(driver.findElement(By.xpath("//span[text()=\"Лаборант\"]")));
//                driver.findElement(By.xpath("//span[text()=\"Лаборант\"]")).click();
...
//                click(driver.findElement(By.xpath("//span[text()=\"Лаборант\"]")));
        ...
        sleep(2000);
        preloader();
//        waitVisibility(successSecondThree);
...
//                        pr(checkServices3.get(i).getAttribute("class") + " = " + CheckedAndFocus);
...
//                pr(checkServices2.get(0).getAttribute("class") + " = " + Checkeds + " or " + CheckedAndFocus);
//                Assert.assertTrue(checkServices2.get(0).getAttribute("class").equals(Checkeds) ||
//                        checkServices2.get(0).getAttribute("class").equals(CheckedAndFocus));

//                pr(checkServices2.get(0).getAttribute("class") + " = " + Checkeds);
...
//                Assert.assertEquals(checkServices2.get(0).getAttribute("class"), Checkeds);
                ...
                try {
                    for (int b = listSelectedCheckBoxInTree.size() - 1; b > -1; b--) {
                        ...
                        pr("Сняли выделение с: " + listStringSelectedServicesInTree.get(b).getText().replace("\n", " "));
...
//                    pr(checkServices3.get(i).getAttribute("class") + " = " + Checkeds);
...
//                pr(checkServices2.get(1).getAttribute("class") + " = " + Checkeds);
...
//                "+ " + Phone.charAt(0) + " (" + Phone.charAt(1) + Phone.charAt(2) + Phone.charAt(3) + ") " + Phone.charAt(4) +
//                        Phone.charAt(5) + Phone.charAt(6) + "-" + Phone.charAt(7) + Phone.charAt(8) + "-" +
//                        Phone.charAt(9) + Phone.charAt(10));
//        pr(SavePhone + " = + " + Phone.charAt(0) + " (" + Phone.charAt(1) + Phone.charAt(2) + Phone.charAt(3) + ") " + Phone.charAt(4) +
//                Phone.charAt(5) + Phone.charAt(6) + "-" + Phone.charAt(7) + Phone.charAt(8) + "-" +
//                Phone.charAt(9) + Phone.charAt(10));

        compareWebelementAndString(saveSecondName, SecondName);
//        Assert.assertEquals(SecondName, saveSecondName.getText());
//        pr(SecondName + " = " + saveSecondName.getText());

        compareWebelementAndString(saveFirstName, FirstName);
//        Assert.assertEquals(FirstName, saveFirstName.getText());
//        pr(FirstName + " = " + saveFirstName.getText());

        compareWebelementAndString(saveMiddleName, MiddleName);
//        Assert.assertEquals(MiddleName, saveMiddleName.getText());
//        pr(MiddleName + " = " + saveMiddleName.getText());

//        compareArrayListAndWebelementsList(SelectedOrg, listSaveWorkSpace, SelectedOrg.size());
        ...
        Assert.assertTrue(SumAmbulance == listSaveAmbulanceYes.size());
...
//            pr(SelectedServices.get(x) + " = " + saveServices.get(x).getText().
//                    replace("\n", " "));
...
//        pr(Education + " = " + saveEducation.getText());

        compareWebelementAndString(saveEmailInfo, EmailInfo);
//        Assert.assertEquals(EmailInfo, saveEmailInfo.getText());
//        pr(EmailInfo + " = " + saveEmailInfo.getText());

        moveMouse(savePhoneInfo);
        compareStringAndString("+ " + PhoneInfo.charAt(0) + " (" + PhoneInfo.charAt(1) + PhoneInfo.charAt(2) +
                PhoneInfo.charAt(3) + ") " + PhoneInfo.charAt(4) + PhoneInfo.charAt(5) + PhoneInfo.charAt(6) + "-" + PhoneInfo.charAt(7) + PhoneInfo.charAt(8) + "-" + PhoneInfo.charAt(9) + PhoneInfo.charAt(10), SavePhoneInfo);
//        Assert.assertEquals(SavePhoneInfo,
//                "+ " + PhoneInfo.charAt(0) + " (" + PhoneInfo.charAt(1) + PhoneInfo.charAt(2) + PhoneInfo.charAt(3) + ") " + PhoneInfo.charAt(4) +
//                        PhoneInfo.charAt(5) + PhoneInfo.charAt(6) + "-" + PhoneInfo.charAt(7) + PhoneInfo.charAt(8) + "-" +
//                        PhoneInfo.charAt(9) + PhoneInfo.charAt(10));
//        pr(SavePhoneInfo + " = + " + PhoneInfo.charAt(0) + " (" + PhoneInfo.charAt(1) + PhoneInfo.charAt(2) + PhoneInfo.charAt(3) + ") " + PhoneInfo.charAt(4) +
//                PhoneInfo.charAt(5) + PhoneInfo.charAt(6) + "-" + PhoneInfo.charAt(7) + PhoneInfo.charAt(8) + "-" +
//                PhoneInfo.charAt(9) + PhoneInfo.charAt(10));

        compareWebelementAndString(saveInstagram, Instagram);
//        Assert.assertEquals(Instagram, saveInstagram.getText());
//        pr(Instagram + " = " + saveInstagram.getText());

        compareWebelementAndString(saveVk, Vk);
//        Assert.assertEquals(Vk, saveVk.getText());
//        pr(Vk + " = " + saveVk.getText());

        compareWebelementAndString(saveWhatsapp, Whatsapp);
//        Assert.assertEquals(Whatsapp, saveWhatsapp.getText());
//        pr(Whatsapp + " = " + saveWhatsapp.getText());

        compareWebelementAndString(saveViber, Viber);
//        Assert.assertEquals(Viber, saveViber.getText());
//        pr(Viber + " = " + saveViber.getText());

        compareWebelementAndString(saveFacebook, Facebook);
//        Assert.assertEquals(Facebook, saveFacebook.getText());
//        pr(Facebook + " = " + saveFacebook.getText());

        compareWebelementAndString(saveOther, Other);
//        Assert.assertEquals(Other, saveOther.getText());
//        pr(Other + " = " + saveOther.getText());

        click(buttonFinish);
//        waitVisibility(successCreate);
    }
...
//        for (WebElement profPosition : listProfPosition) {
//            pr(profPosition.getText());
//            if (!profPosition.getText().equals("") || !profPosition.getText().equals(" ") ||
//                    !profPosition.getText().equals(",")) {
//                ListProfPositions.add(profPosition.getText().replace(",", ""));
//            }
//        }
//        compareArrayListAndArrayList(SelectedPositions, ListProfPositions, SelectedPositions.size());

//        compareWebelementAndString(profPosition.get(0), Position);
//        pr(Position + " = " + profPosition.get(0).getText());
//        Assert.assertEquals(Position, profPosition.get(0).getText());
...
//        pr("Специальности при создании: " + SelectedSpecialtys);
//        pr("Специальности в профиле: " + ListProfSpeciality);
//        int i = -1;
...
//                u = 0;
//                pr("Специальность №" + x);
//                pr("Сравниваем специальности: " + SelectedSpecialtys.get(x) + " = " +
//                        Spec);
//                if (SelectedSpecialtys.get(x).equals(Spec)) {
//                    u = u + 1;
//                    pr("!+Speciality finded+!");
//                    break;
//                } else {
//                    pr("Специальности не совпали");
//                }
//            }
...
//        }
        ...
        sleep(1000);
//        pr(SelectedOrg);
//        pr(ListProfNameWorkspace);
//        Assert.assertEquals(SelectedOrg.size(), listProfNameWorkspace.size());
//        Assert.assertEquals(listProfNameWorkspace.size(), ListProfNameWorkspace.size());
//        for (String Act : SelectedOrg) {
//            i = i + 1;
//            for (String Exp : ListProfNameWorkspace) {
//                u = 0;
//                pr(Act.replace(",", "") + " = " + Exp.replace(",", ""));
//
//
//                if (Exp.replace(",", "").contains(Act.replace(",", ""))) {
//                    u = u + 1;
//                    pr("!+Match finded+!");
//                    break;
//                } else {
...
//        pr("Сравнивам места работы :" + SelectedOrg.equals(ListProfNameWorkspace));
//        Assert.assertEquals(SelectedOrg, ListProfNameWorkspace);
        ...
        compareArrayListAndArrayList(SelectedPositions, ListProfPositions, SelectedPositions.size());
//        pr("Сравнивам должности в местах работы :" + SelectedPositions.equals(ListProfPositions));
...
//        pr("Сравнивам роли в местах работ :" + SelectedRoles.equals(ListProfRoles));
...
//        pr(Education + " = " + profEducation.getText());
...
//        pr("Сравнивам услуги :" + SelectedServices.equals(ListProfServices));
...
//        pr(EmailInfo + " = " + profEmail.getText());
...
//        pr(profContPhone.getText() + " = + " + PhoneInfo.charAt(0) + " (" + PhoneInfo.charAt(1) + PhoneInfo.charAt(2) + PhoneInfo.charAt(3) + ") " + PhoneInfo.charAt(4) +
//                PhoneInfo.charAt(5) + PhoneInfo.charAt(6) + "-" + PhoneInfo.charAt(7) + PhoneInfo.charAt(8) + "-" +
//                PhoneInfo.charAt(9) + PhoneInfo.charAt(10));
...
//        pr(Whatsapp + " = " + profWhatsapp.getText());
        compareWebelementAndString(profViber, Viber);
//        Assert.assertEquals(Viber, profViber.getText());
//        pr(Viber + " = " + profViber.getText());
        compareWebelementAndString(profFacebook, Facebook);
//        Assert.assertEquals(Facebook, profFacebook.getText());
//        pr(Facebook + " = " + profFacebook.getText());
        compareWebelementAndString(profOther, Other);
//        Assert.assertEquals(Other, profOther.getText());
//        pr(Other + " = " + profOther.getText());
        compareWebelementAndString(profAccLogin, Login);
//        pr(Login + " = " + profAccLogin.getText());
//        Assert.assertEquals(Login, profAccLogin.getText());
        compareWebelementAndString(profAccEmail, Email);
//        pr(Email + " = " + profAccEmail.getText());
//        Assert.assertEquals(Email, profAccEmail.getText());
        compareWebelementAndString(profAccPhone, "+ " + Phone.charAt(0) + " (" + Phone.charAt(1) + Phone.charAt(2) + Phone.charAt(3) + ") " + Phone.charAt(4) + Phone.charAt(5) + Phone.charAt(6) + "-" + Phone.charAt(7) + Phone.charAt(8) +
                "-" + Phone.charAt(9) + Phone.charAt(10));
//        pr(profAccPhone.getText() + " = + " + Phone.charAt(0) + " (" + Phone.charAt(1) + Phone.charAt(2) + Phone.charAt(3) + ") "
//                + Phone.charAt(4) + Phone.charAt(5) + Phone.charAt(6) + "-" + Phone.charAt(7) + Phone.charAt(8) +
//                "-" + Phone.charAt(9) + Phone.charAt(10));
//        Assert.assertEquals(profAccPhone.getText(),
//                "+ " + Phone.charAt(0) + " (" + Phone.charAt(1) + Phone.charAt(2) + Phone.charAt(3) + ") "
//                + Phone.charAt(4) + Phone.charAt(5) + Phone.charAt(6) + "-" + Phone.charAt(7) + Phone.charAt(8) +
//                "-" + Phone.charAt(9) + Phone.charAt(10));
