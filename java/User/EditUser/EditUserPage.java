...
public class EditUserPage extends GlobalPage {
    ...
    public EditUserPage(RemoteWebDriver driver) {
...
// Место работы и специальность
    ...
    @FindBy(xpath = "//span[contains (text(), \"Удалить место работы?\")]/../../..//button//span[contains (text(), \"Удалить\")]")
    ...
    @FindBy(xpath = "//span[contains (text(),\"Ведет амбулаторный приём\")]/../span[@aria-checked=\"mixed\"]/span[@class=\"el-checkbox__inner\"]")
