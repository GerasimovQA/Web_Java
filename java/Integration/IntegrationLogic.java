...
public class IntegrationLogic {
    ...
    public ArrayList<String> ListSpecialtysInProfile = new ArrayList<>();
    public ArrayList<String> ListNamesServices = new ArrayList<>();
    public ArrayList<String> ListVendorsServices = new ArrayList<>();
    public ArrayList<String> ListCostsServices = new ArrayList<>();
    public ArrayList<String> ListEmployersServices = new ArrayList<>();
    public ArrayList<String> ListWorkers = new ArrayList<>();
    public ArrayList<String> ListNumberExecutorServices = new ArrayList<>();
...
//        driver.get(ConfigProperties.getTestProperty("baseurl") + "#/departments/" + EnvironmentIntegration.OrganizationID1);
//        System.out.println(ConfigProperties.getTestProperty("baseurl") + "#/departments/" + EnvironmentIntegration.OrganizationID1);
//        p.preloader();
//        p.waitTextPresent(p.buttonEditOrganization, "Редактировать профиль");
