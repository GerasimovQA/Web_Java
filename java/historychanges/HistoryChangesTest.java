...
public class HistoryChangesTest extends HistoryChangesLogic {
    ...
    @Test   //4.3
    @Parameters(value = {
            "Shaaskjd90oiy61| 6simbo | 45al1913fd1@mail.ru | +72083028361 | active| Алиханов | Антуанет | Экзи | true",
    })
    ...
    @Parameters(value = {
            "26fo.gi_ni-dze14 | maillidzanov@mail.ru | 0033253333     |Shaaskjda2r4fy61| bbcu9s89jkdslk | " +
                    "smdlskjiofd1@mail.ru | +72083179561 | active| Алиханидзе | Антуанетка | Экзестиционстовна | true",
    })
    ...
    @Test //4.7
    @Parameters(value = {
            "Shaaskfsfsdfoiy61 | 11111111@mail.ru | +7 (111) 111-11-11 | msnd87987uidkjs |  active | Освобожденный | " +
                    "Джанго | Иванович | true",
    })
    public void popoverInfoBlockTest(String Login, String Email, String Phone, String Password, String Status,
                                     String SecondName, String FirstName, String MiddleName, String Superuser) {
        popoverInfoBlock(Login, Email, Phone, Password, Status, SecondName, FirstName, MiddleName, Superuser);
    }
    ...
    @Test //4.10
    @Parameters(value = {
            "Shaas3skjd90oiy61| 6simbefo | 45al191533fd1@mail.ru | +7 (208) 398-28-61 | Алиман | Салиман | " +
                    "Пакуман | true | org:5b7d08aa068d7552d904d8be | Врачеватель | org:5b7d08aa068d7552d904d8be | " +
                    "Специалист" +
                    " | active | акушер | Образование | емайлК | +7 (000) 000-00-00 | инста | ВК | Ватцап | вайбер |" +
                    " Фейсбук | Др",
    })
...
///////////////////////////////////////////Test-User////////////////////////////////////////////////////////////////////
    ...
    @Parameters(value = {
            "26fo.gi_ni-dzijf4 | mail579nov@mail.ru | 0033230933     |Sha908sdda2r4fy61| bbcu9s898fdulk | " +
                    "smdl456ofd1@mail.ru | +72062479561 | active| Popov | Oleg | Koshkovich | true",
    })
    ...
    @Test //4.22
    @Parameters(value = {
            "Sh0686sfsdfoiy61 | 111231111@mail.ru | +7 (123) 111-11-11 | msnd87923dkjs |  active | Smith | " +
                    "Agent | From Matrix | true",
    })
    public void popoverInfoBlockUserTest(String Login, String Email, String Phone, String Password, String Status,
                                         String SecondName, String FirstName, String MiddleName, String Superuser) {
        popoverInfoBlockUser(Login, Email, Phone, Password, Status, SecondName, FirstName, MiddleName, Superuser);
    }
    ...
    @Parameters(value = {
            "Shaskdj990oiy61| 6simbefo | 45akjdfhkdsj533fd1@mail.ru | +7 (208) 343-28-61 | Алмаз | Иннокентий | " +
                    "Кешевич | true | org:5b7d08aa068d7552d904d8be | Докторелло | org:5b7d08aa068d7552d904d8be | " +
    ...
    @Test //4.26
    @Parameters(value = {
            "Shaaslkl3j431y61| 6жdjf354mbo | 45al154dsffd1@mail.ru | +72082542461 | active | Hook | Captain || " +
                    "true",
    })
    ...
    public void actionFilterUserTest(String SecondName) {
        actionFilterUser(SecondName);
    }
