...
public class GlobalSearchEditTest extends GlobalSearchEditLogic {
    ...
    public void searchFullUserID() {
        searchEditUser(EnvironmentGlobalSearch.UserID1);
    }
    ...
    public void searhOrgEditID() {
        searchEditOrg(EnvironmentGlobalSearch.OrganizationID);
    }
    ...
    public void searchServiceID() {
        searchNewService(EnvironmentGlobalSearch.ServiceID1);
    }
...
//
    ...
    public void searchSpecialtyID() {
        searchNewSpecialty(EnvironmentGlobalSearch.ServicesSectionID);
    }
}
