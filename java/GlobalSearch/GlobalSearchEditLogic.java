...
public class GlobalSearchEditLogic {
    ...
    public static void createUser() {
        String Login = "1SLxfvbvcbgggrdGI";
        String Password = "1nber2vbvb334hj78wds";
        String Email = "Orlova@sech.lionsdigital.pro";
        String Phone = "+ 7 (927) 111-11-22";
