...
public class GlobalSearchDeleteLogic {
    ...
    private static String SecondName = "Урюпинский";
    private static String FirstName = "Гектор";
    private static String MiddleName = "Каземирович";
    static String NewSecondName = "Орлова";
    static String NewFirstName = "Анжелина";
    static String NewMiddleName = "Петровна";

    private static String NameOrg = "Большая такая организация с разными медицинскими услугами";
    ...
    private static String NameService = "Кроим, режем и шьем";
    static String NewNameService = "Лечим, любим, жалеем";
    static String NewVendorService = "арт.09933-1";

    private static String NameSpecialty = "Сниматель швов";
    ...
    public static void createService() {
        ...
        Token = globalSearchAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        String vendorService = "арт.5345-335";
