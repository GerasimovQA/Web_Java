...
//            driver.quit();
    ...
    public static void createUser() {
        ...
        String userID = globalSearchAPI.createUserAPI(Token, Login, Password, Email, Phone, Status, SecondName, FirstName, MiddleName,
    ...
    public static void createOrg() {
        ...
        Token = globalSearchAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        String orgID = globalSearchAPI.createOrganizationAPI(Token, Parent);
    ...
    public static void createService() {
        ...
        Token = globalSearchAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        String serviceID = globalSearchAPI.createServiceAPI(Token, CodeService, NameService, PrintNameService, Parent,
    ...
    public static void createSpecialty() {
        ...
        Token = globalSearchAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        String specialtyID = globalSearchAPI.createSpecialtyAPI(Token, NameSpecialty, Description1, Icon1, Parent1);
    }
