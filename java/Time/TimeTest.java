...
public class TimeTest extends TimeLogic {
    ...
    public void TimeTestApiLoginCreateProfileUploadphoto(String Login, String Email, String Phone,
        ...
        Token = timeLogic.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        UserID = timeLogic.createUserAPI(Token, Login, Password, Email, Phone, Status, SecondName, FirstName, MiddleName,
