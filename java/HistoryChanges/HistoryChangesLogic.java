...
public class HistoryChangesLogic {
    public HistoryChangesAPI historyChangesAPI = new HistoryChangesAPI();
...
//                System.out.println(p.columnAction.get(i).getText());
//                Assert.assertTrue(p.columnAction.get(i).getText().equals("Создание пользователя"));

                p.compareWebelementAndString(p.columnObject.get(i), SecondName + " " + FirstName + " " + MiddleName);
//                System.out.println(p.columnObject.get(i).getText() + "=" + SecondName + " " + FirstName + " " + MiddleName);
//                Assert.assertTrue(p.columnObject.get(i).getText().equals(SecondName + " " + FirstName + " " + MiddleName));
                return;
    ...
    public void logEditWorker(String NewLogin, String NewEmail, String NewPhone, String Login
        ...
        for (WebElement timeOne : p.columnTime) {
            ...
            if (timeOne.getText().equals(NowDate) & i == 0) {
                ...
                System.out.println(p.columnAction.get(i).getText());
                Assert.assertTrue(p.columnAction.get(i).getText().equals("Изменение профиля"));
...
//                Assert.assertTrue(p.columnObject.get(i).getText().equals(SecondName + " " + FirstName + " " + MiddleName));
    ...
    public void logSumReportsDefoulte() {
        ...
        p.waitVisibility(p.marker10History);
        System.out.println("Количество строк: " + p.columnAction.size());
        Assert.assertTrue("Количество записей по-умолчанию не равно 10", p.columnAction.size() == 10);
    }
...
//        System.out.println(p.popoverPhone.getText() + " = " + Phone);
//        Assert.assertEquals(p.popoverPhone.getText(), Phone);

        p.compareWebelementAndString(p.popoverEmail, Email);
//        System.out.println(p.popoverEmail.getText() + " = " + Email);
//        Assert.assertEquals(p.popoverEmail.getText(), Email);
...
//        System.out.println(p.fioUser.getText() + " = " + SecondName + " " + FirstName + " " + MiddleName);
//        Assert.assertEquals(p.fioUser.getText(), SecondName + " " + FirstName + " " + MiddleName);
...
//        System.out.println(p.popoverPhone.getText() + " = + 7 (123) 456-78-99");
//        Assert.assertEquals("+ 7 (123) 456-78-99", p.popoverPhone.getText());

        p.compareWebelementAndString(p.popoverEmail, "ioanner@mail.ru");
//        System.out.println(p.popoverEmail.getText() + " = ioanner@mail.ru");
//        Assert.assertEquals("ioanner@mail.ru", p.popoverEmail.getText());

        p.click(p.popoverMore);
        p.waitVisibility(p.userinfoname);

        p.compareWebelementAndString(p.fioUser, "Акулин Аристарх Анатольевич");
//        System.out.println(p.fioUser.getText() + " = Акулин Аристарх Анатольевич");
//        Assert.assertEquals("Акулин Аристарх Анатольевич", p.fioUser.getText());
            ...
            if (actionOne.getText().equals("Создание пользователя")) {
                ...
                Assert.assertTrue("Не все элементы присутствуют в блоке",
                        !p.blocInfoAboutEventDate.getText().equals("") & !p.blocInfoAboutEventInitiator.getText().equals("") &
                                ...
                                !p.blockMoreInfoContextFirstnameValue.getText().equals("") & !p.blockMoreInfoContextSecondnameValue.getText().equals("") &
                                !p.blockMoreInfoContextMidlenameValue.getText().equals("") & !p.blockMoreInfoContextStatusValue.getText().equals("") &
...
//                System.out.println(p.columnAction.get(i).getText());
//                Assert.assertTrue(p.columnAction.get(i).getText().equals("Логаут"));
...
//        p.moveToProfileUser(SecondName);
    ...
    public void popoverInfoBlockUser(String Login, String Password, String Email, String Phone, String Status,
        ...
        p.auth(Login, Password);
        System.out.println("2");
//        p.moveToProfileUserID(SecondName);
        p.click(p.tabHistoryChanges);
        System.out.println("3");
        p.sleep(1000);
        p.click(p.columnInitiator.get(0));
        ...
        p.compareWebelementAndString(p.popoverPhone, Phone);
//        System.out.println(p.popoverPhone.getText() + " = " + Phone);
//        Assert.assertTrue(p.popoverPhone.getText().equals(Phone));

        p.compareWebelementAndString(p.popoverEmail, Email);
//        System.out.println(p.popoverEmail.getText() + " = " + Email);
//        Assert.assertTrue(p.popoverEmail.getText().equals(Email));


        p.click(p.popoverMore);
        p.waitVisibility(p.userinfoname);
        p.compareWebelementAndString(p.userinfoname, SecondName + " " + FirstName + " " + MiddleName);
//        System.out.println(p.userinfoname.getText() + " = " + SecondName + " " + FirstName + " " + MiddleName);
//        Assert.assertTrue(p.userinfoname.getText().equals(SecondName + " " + FirstName + " " + MiddleName));
...
//        System.out.println(p.popoverInitiator.getText() + " =  Тот кто совершает действие.");
//        Assert.assertTrue(p.popoverInitiator.getText().equals("Тот кто совершает действие."));
        p.click(p.questionObject);

        p.compareWebelementAndString(p.popoverObject, "Над кем совершают действие.");
//        System.out.println(p.popoverObject.getText() + " =  Над кем совершают действие.");
//        Assert.assertTrue(p.popoverObject.getText().equals("Над кем совершают действие."));
//        File file = new File("/home/alex/Dropbox/IdeaProjects/LionsDigital/Files/2002.png");
//        if (file.exists()) {
//            System.out.println(p.getFileSizeKiloBytes(file));
...
//            p.compareWebelementAndString(timeOne, p.todayDate());
            System.out.println(timeOne.getText() + " содержит " + p.todayDate());
            Assert.assertTrue(timeOne.getText().contains(p.todayDate()));
        }
        p.scrollHomePage();
