...
import Global.EnvironmentEditPassword;
import junitparams.Parameters;
import org.junit.Test;

public class EditPasswordTest extends EditPasswordLogic {
    EnvironmentEditPassword environmentEditPassword = new EnvironmentEditPassword();
    ...
    public void editPasswordOfMyselfTest(String LoginIN, String PasswordIN, String EmailIN, String PhoneIN,
        ...
        environmentEditPassword.login();
        environmentEditPassword.createUserAPI(LoginIN, PasswordIN, EmailIN, PhoneIN, StatusIN, SecondNameIN, FirstNameIN, MiddleNameIN, SuperuserIN, SendEmailIN, OrgIDIN, OrgStatusIN, Post1IN, Post2IN, Role1IN, Role2IN);
    ...
    public void editPasswordOfSuperAdminTest(String RoleIn,
        ...
        environmentEditPassword.login();
        environmentEditPassword.createUserAPI(LoginOBJ, PasswordOBJ, EmailOBJ, PhoneOBJ, StatusOBJ, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, SuperuserOBJ, SendEmailOBJ, OrgIDOBJ, OrgStatusOBJ, Post1OBJ, Post2OBJ, Role1OBJ, Role2OBJ);

        editPasswordOfSuperAdmin(RoleIn, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, LoginOBJ, NewPasswordOBJ, environmentEditPassword.getUserID());
    ...
    public void editPasswordOfAdminMyselfOrgTest(String RoleIn,
        ...
        environmentEditPassword.login();
        environmentEditPassword.createUserAPI(LoginOBJ, PasswordOBJ, EmailOBJ, PhoneOBJ, StatusOBJ, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, SuperuserOBJ, SendEmailOBJ, OrgIDOBJ, OrgStatusOBJ, Post1OBJ, Post2OBJ, Role1OBJ, Role2OBJ);
        editPasswordOfAdmin(RoleIn, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, LoginOBJ, NewPasswordOBJ, environmentEditPassword.getUserID());
//        findLetterMailRu(LoginOBJ, PasswordOBJ, EmailOBJ);
    }
...
//        findLetterMailRu(LoginOBJ, PasswordOBJ, EmailOBJ);
    ...
    public void editPasswordOfAdminHighLevelOrgTest(String RoleIN,
        ...
        editPasswordOfUserHighLevelOrg(RoleIN, LoginIN, PasswordIN, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, LoginOBJ, NewPasswordOBJ,
                environmentEditPassword.getUserID());
//        findLetterMailRu(LoginOBJ, PasswordOBJ, EmailOBJ);
    }
...
//        findLetterMailRu(LoginOBJ, PasswordOBJ, EmailOBJ);
    ...
    public void adminSpecEditPasswordOfSpecMyselfOrgTest(String RoleIN, String LoginIN, String PasswordIN, String EmailIN,
        ...
        environmentEditPassword.createUserAPI(LoginIN, PasswordIN, EmailIN, PhoneIN, StatusIN, SecondNameIN, FirstNameIN, MiddleNameIN, SuperuserIN, SendEmailIN, OrgIDIN, OrgStatusIN, Post1IN, Post2IN, Role1IN, Role2IN);
        environmentEditPassword.createUserAPI(LoginOBJ, PasswordOBJ, EmailOBJ, PhoneOBJ, StatusOBJ, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, SuperuserOBJ, SendEmailOBJ, OrgIDOBJ, OrgStatusOBJ, Post1OBJ, Post2OBJ, Role1OBJ, Role2OBJ);
        adminSpecEditPasswordOfSpecMyselfOrg(RoleIN, LoginIN, PasswordIN, SecondNameOBJ, FirstNameOBJ, MiddleNameOBJ, LoginOBJ, NewPasswordOBJ
                , environmentEditPassword.getUserID());
//        findLetterMailRu(LoginOBJ, PasswordOBJ, EmailOBJ);
    }
