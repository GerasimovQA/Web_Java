...
public class TimeTest extends TimeLogic {
    ...
    @Test   //
    @Parameters(value = {
            "Shavermay61 | al1911@mail.ru | 9862648361 | 6simbo | active | Коршунов | Игорь | Эдуардович | true | Сеченовский университет > Больница 1 | Врач | Специалист| Дантист | Консультации | 0 | Консультация доцента | 3000 руб. | 1 | Высшее медицинское | qua@mail.ru | 7954357543 | INSTA | VK | WATSAPP | VIBER | FACEBOOK | OTHER | medicina_1696.jpg",
    })
