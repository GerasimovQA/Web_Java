...
public class TimeTest extends TimeLogic {
    ...
    @Test   //
    @Parameters(value = {
            "Shavernos61 | al1956uhg67@mail.ru | 9863258361 | 6simbo | active | Коршенидзе | Игорррррр | Вах-Вахович | true | Сеченовский университет > Больница 1 | Врач | Специалист| Дантист | Консультации | 0 | Консультация доцента | 3000 руб. | 1 | Высшее медицинское | qua@mail.ru | 7954357543 | INSTA | VK | WATSAPP | VIBER | FACEBOOK | OTHER | medicina_1696.jpg",
    })
