...
public class AutorizationTest extends AutorizationLogic {
    ...
    public void succesAutorization(String LoginInput, String Password, String Phrase, String Login, String Email,
                                   ...
                                   String Role2) {
        String token = autorizationAPI.loginAPI(GlobalPage.LoginAUT_SA, GlobalPage.PasswordAUT_SA);
        autorizationAPI.createUserAPI(token, Login, Password, Email, Phone, Status, SecondName, FirstName, MiddleName,
