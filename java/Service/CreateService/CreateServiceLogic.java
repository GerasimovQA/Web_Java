...
public class CreateServiceLogic {
    ...
    String RandomSubsectionName = "";
    String RandCharacter = "";
    String ServiceID = "";
    String SectionServiceID = "";
...
//                p.waitVisibility(p.listCharacterService.get(0));
...
//        p.click(driver.findElement(By.xpath("//span[contains(text(),\"Удалить услугу?\")]" +
