...
public class EditServicePage extends GlobalPage {
    ...
    @FindBy(xpath = "//div[contains(text(),\"Раздел услуги\")]/following-sibling::div/div//" +
            "div[@role=\"group\"]//span[@class=\"el-tree-node__label\"]")
    ...
    @FindBy(xpath = "//div[contains(text(),\"Противопоказания\")]/following-sibling::div/" +
            "button/span[contains(text(),\"Сохранить\")]")
    ...
    //   Кнопка "Удалить"
    @FindBy(xpath = "//span[contains(text(),\"Удалить услугу?\")]/../../following-sibling::div//" +
