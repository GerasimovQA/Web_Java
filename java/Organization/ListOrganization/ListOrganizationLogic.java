...
//            driver.quit();
    ...
    public void nameOrg() {
        p.sleep(3000);
//        int ShowOrg = Integer.parseInt(p.showOrg.getText());
...
//        Assert.assertTrue(ShowOrg == AllOrg);
    }
...
//                    p.moveMouse(p.listTriggerOrg.get(0));
...
//        for (WebElement Name : p.listNameOrg) {
//            i = i + 1;
//            System.out.println("Орг№ " + i + ": " + Name.getText());
//            if (Name.getText().equals("ФГАОУ ВО Первый МГМУ им. И.М. Сеченова Минздрава России (Сеченовский " +
//                    "Университет)")){
//                continue;
//            }
//                try {
...
//                    System.out.println("Триггер: " + trigger);
//                    p.click(Name);
//
//                } catch (NoSuchElementException e) {
//                    p.waitVisibility(Name);
...
//        }
        ...
        try {
            for (WebElement Name2 : p.listNameOrg) {
                ...
                Assert.assertTrue("Найдена удаленная организация", !Name2.equals(p.StepashinForDelete.getText()));
            }
        } catch (NoSuchElementException e) {
