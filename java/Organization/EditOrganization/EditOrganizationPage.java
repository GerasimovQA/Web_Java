...
public class EditOrganizationPage extends GlobalPage {
    ...
    EditOrganizationPage(RemoteWebDriver driver) {
    ...
    @FindBy(xpath = "//div[@class=\"info-block__title\"]/span[contains (text(),\"Оказываемые услуги \")]/../../../.." +
    ...
    void servicess(String Abbr, String CheckedAndFocus, String Checkeds, String Indeterminate,
                   String Empty) {
        int i = -1;
        sleep(3000);
        switch (Abbr) {
