...
public class EditOrganizationLogic {
    ...
    String NowDateEdit = "";
    String NowDateEditAddMin = "";

    public ArrayList<String> ListSaveServices = new ArrayList<>();
    public ArrayList<String> ListServicesInProfile = new ArrayList<>();
    public ArrayList<String> ListNamePhone = new ArrayList<>();
    public ArrayList<String> ListNumberPhone = new ArrayList<>();
...
//        System.out.println(driver.findElement(By.xpath("//span[@class=\"chief__name\"]")).getText());
//        driver.findElement(By.xpath("//span[@class=\"chief__name\"][contains (text(),\"+ FIODirector +\")]")).click();
...
//        p.compareStringAndString(NowDateCreate, p.lastChangeProfOrg.getText());
//        p.compareStringAndString(NowDateCreate, p.dateCreateProfOrg.getText());
//        p.compareStringAndString(NowDateEdit, p.lastChangeProfOrg.getText());
...
//        p.waitVisibility(p.listNameOrganizations);
    }
...
//        p.moveMouse(p.SelectedServices);
...
//        p.compareStringAndString(NowDateCreate, p.dateCreateProfOrg.getText());
        p.moveMouse(p.lastChangeProfOrg);
        System.out.println("Дата редактирования в профиле: " + p.lastChangeProfOrg.getText());
        System.out.println("Фактическая дата редактирования: " + NowDateCreate);
        System.out.println("Фактическая дата редактирования + 1 мин: " + NowDateCreateAddMin);
        Assert.assertTrue(NowDateEdit.equals(p.lastChangeProfOrg.getText()) ||
                NowDateEditAddMin.equals(p.lastChangeProfOrg.getText()));

//        p.compareStringAndString(NowDateCreate, p.lastChangeProfOrg.getText());
//        p.compareStringAndWebelement(NowDateCreate, p.dateCreateProfOrg);
//        p.compareStringAndWebelement(NowDateEdit, p.lastChangeProfOrg);
        Assert.assertTrue(p.qrProfOrg.isEnabled());
    }
    ...
    public void editAdditionalInformationOrganization(String OrganizationID, String Name, String DescriptionOrganization,
        ...
        Assert.assertTrue(!NumberPhone1.equals(NumberPhone2) & NumberPhone2.equals("+ 9 (" + NewNumberPhone1.charAt(0) +
                NewNumberPhone1.charAt(1) + NewNumberPhone1.charAt(2) + ") " + NewNumberPhone1.charAt(3) +
                NewNumberPhone1.charAt(4) + NewNumberPhone1.charAt(5) + "-" + NewNumberPhone1.charAt(6) + NewNumberPhone1.charAt(7) + "-" +
                NewNumberPhone1.charAt(8) + NewNumberPhone1.charAt(9)));
...
//        NowDateEditAddMin = GlobalPage.nowDateAdd1Min();
        ...
        System.out.println("NowDateEdit = " + GlobalPage.nowDate());
        NowDateEdit = GlobalPage.nowDate();
        System.out.println("NowDateEditAddMin = " + GlobalPage.nowDate());
        NowDateEditAddMin = GlobalPage.nowDateAdd1Min();
...
//        NowDateEdit = GlobalPage.nowDate();
        ...
        p.waitTextPresent(p.listNumbersPhoneProfOrg.get(0), "+ 9 (" + NewNumberPhone1.charAt(0) + NewNumberPhone1.charAt(1) +
                NewNumberPhone1.charAt(2) + ") " + NewNumberPhone1.charAt(3) + NewNumberPhone1.charAt(4) +
                NewNumberPhone1.charAt(5) + "-" + NewNumberPhone1.charAt(6) + NewNumberPhone1.charAt(7) + "-" +
                NewNumberPhone1.charAt(8) + NewNumberPhone1.charAt(9));
//        p.compareStringAndString("+ 9 (" + NewNumberPhone1.charAt(0) + NewNumberPhone1.charAt(1) +
//                NewNumberPhone1.charAt(2) + ") " + NewNumberPhone1.charAt(3) + NewNumberPhone1.charAt(4) +
//                NewNumberPhone1.charAt(5) + "-" + NewNumberPhone1.charAt(6) + NewNumberPhone1.charAt(7) + "-" +
//                NewNumberPhone1.charAt(8) + NewNumberPhone1.charAt(9), p.listNumbersPhoneProfOrg.get(0).getText());
...
//        NowDateEditAddMin = GlobalPage.nowDateAdd1Min();
        ...
        String Facebook2 = p.facebookOrganization.getText();
        String Instagram2 = p.instagramOrganization.getText();
        String Other2 = p.otherNameOrganization.getText();
...
//        p.compareStringAndString(NowDateCreate, p.lastChangeProfOrg.getText());
//        p.compareStringAndWebelement(NowDateCreate, p.dateCreateProfOrg);
//        p.compareStringAndWebelement(NowDateCreate, p.lastChangeProfOrg);
        p.moveMouse(p.qrProfOrg);
        Assert.assertTrue(p.qrProfOrg.isEnabled());
    }
    ...
    public void editPhonesOrganization(String OrganizationID, String Name, String NamePhone1, String NumberPhone1,
        ...
        Assert.assertEquals(NumberPhoneSite2, "+ 9 (" + NewNumberPhone2.charAt(0) +
