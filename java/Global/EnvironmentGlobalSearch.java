...
public class EnvironmentGlobalSearch {

    static String Token = "";
    public static String ServicesSectionID = "";
...
//        System.out.println("Ответ при авторизации: " + response.getBody().asString());
...
//    }
//
//    public static void profileUserAPI(String Spec1, String Spec2, String Service1, String Service2, String Regalia,
...
//    }
//
//    public static void editInfoOrganizationAPI(String NewNameOrg, String NewAbbrOrg, String NewService1) {
//        Map<String, Object> jsonAsMapProfile = new HashMap<>();
...
////        Object ListBlocks[] = {jsonAsMapNewInfoOrg, jsonAsMapOneServices};
//
...
//        jsonAsMapProfile.put("blocks", jsonAsMapBlocks);
//
////        jsonAsMapInfo.put("info", jsonAsMapNewInfoOrg);
////        jsonAsMapOneServices.put("info", jsonAsMapNewInfoOrg);
//
////        jsonAsMapProfile.put("blocks", ListBlocks);
//
//        Response response =
//                given().log().all().
//                        header("Authorization", "Bearer " + Token).
...
//    }
//
//    public static void deletOrganizationAPI() {
//        Map<String, Object> jsonAsMapProfile = new HashMap<>();
//
//        jsonAsMapProfile.put("doc_id", OrganizationID);
//
...
//    }
//
//    public static void editSpecialtyAPI(String NewName, String NewDescription, String Icon1, String Parent1) {
//        Map<String, Object> jsonAsMapProfile = new HashMap<>();
//
