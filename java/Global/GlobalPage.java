...
//    public static String PasswordAUT_S = "kovalchuk";
    ...
    @FindBy(css = "body > div.el-select-dropdown.el-popper > div.el-scrollbar > " +
            "div.el-select-dropdown__wrap.el-scrollbar__wrap > ul > li:nth-child(4) > span")
    ...
    @FindBy(xpath = "(//*[@class=\"el-popover el-popper\"]//span[@class=\"el-checkbox__input\"]/" +
    ...
    @FindBy(xpath = "//span[contains (text(),\"Медицинские специальности\")]/../following-sibling::div//" +
            "div[@style=\"padding-left: 1px;\"]/span[@class=\"el-tree-node__label\"]/../label/span/span")
    public List<WebElement> listMedSpecialty;

    //Чек-боксы специальностей в разделе НЕмедицинские специальности
    @FindBy(xpath = "//span[contains (text(),\"Немедицинские специальности\")]/../following-sibling::div//" +
            "div[@style=\"padding-left: 1px;\"]/span[@class=\"el-tree-node__label\"]/../label/span/span")
    ...
    @FindBy(xpath = "//i[@class=\"fa fa-rub\"]/../../../../../../div[@style=\"padding-left: 72px;\"]//" +
            "label/span[@class=\"el-checkbox__input is-checked\"]")
    public List<WebElement> listSelectedCheckBoxInTree;

    //Список выделенных услуг 3 уровня в дереве услуг
    @FindBy(xpath = "//i[@class=\"fa fa-rub\"]/../../../../..//label/span[@class=\"el-checkbox__input is-checked\"]" +
...
//    public List<WebElement> listTriggerExecutorProfOrg;
    ...
    @FindBy(xpath = "//div[contains(text(),\"Структура организации\")]/following-sibling::div//" +
            "div[contains(text(),\"Организации\")]")
    ...
    @FindBy(xpath = "//div[contains(text(),\"Статус в системе\")]/following-sibling::div//" +
            "input[@placeholder=\"Статус в системе\"]")
    ...
    @FindBy(xpath = "//div[contains(text(),\"Статус Online/Offline\")]/following-sibling::div//" +
    ...
    @FindBy(xpath = "//div[contains(text(),\"Глобальная роль\")]/following-sibling::div//" +
            "input[@placeholder=\"Глобальная роль\"]")
    ...
    @FindBy(xpath = "//div[@class=\"el-tree-node__content\"][@style=\"padding-left: 18px;\"]//" +
            "span[@class=\"services-tree__node-name\"]")
    ...
    @FindBy(xpath = "//div[@style=\"padding-left: 54px;\"]//" +
            "div[@class=\"services-tree__row name vendor_code price actions details favorite\"]/div[1]")
    ...
    @FindBy(xpath = "//span[contains(text(),\"Удалить кабинет?\")]/../../following-sibling::div//" +
    ...
    @FindBy(xpath = "//span[contains(text(),\"Удалить кабинет?\")]/../../following-sibling::div//" +
            "span[contains(text(),\"Отмена\")]")
    public WebElement buttonCancelDeleteCabinet;

    //Кнопка "Удалить рабочее место" при редактировании
    @FindBy(xpath = "//span[contains(text(),\"Удалить рабочее место?\")]/../../following-sibling::div//" +
            "span[contains(text(),\"Удалить\")]")
...
//        System.out.println(Locator);
    ...
    public void moveToProfileOrgID(String OrganizationID) {
        if (!OrganizationID.equals("")) {
            System.out.println(ConfigProperties.getTestProperty("baseurl") + "#/departments/" + OrganizationID);
            driver.get(ConfigProperties.getTestProperty("baseurl") + "#/departments/" + OrganizationID);
            preloader();
